...
comp1 = signature(r'D:\cyber project\Land_1.txt',p,q,g,x)

argv.append(buffer(comp1[0],comp1[1],'Konark Patel'))
#print("test----r-", argv[0].r)
comp2 = signature(r'D:\cyber project\Land_2.txt',p,q,g,x)

argv.append(buffer(comp2[0],comp2[1],'Nikhil Harshwardhan'))
